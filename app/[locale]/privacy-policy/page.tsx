...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'en': 'https://avifkit.com/privacy-policy',
        'es': 'https://avifkit.com/es/privacy-policy',
        'ja': 'https://avifkit.com/ja/privacy-policy',
        'fr': 'https://avifkit.com/fr/privacy-policy',
        'x-default': 'https://avifkit.com/privacy-policy',
      },
    },
  };
}
        ...
        <div className="legal-document prose prose-slate max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="my-6 rounded-xl border border-blue-200 bg-blue-50 p-6">
              <p className="mb-2 font-semibold text-blue-900">{t('sections.introduction.principle_title')}</p>
